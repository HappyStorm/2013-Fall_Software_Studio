...
import netdb.courses.softwarestudio.recommender.analysis.BadLowerCaseFilter;
import netdb.courses.softwarestudio.recommender.analysis.BadStopFilter;
...
//		TokenFilter stemFilter = new StemFilter(stopFilter);
		...
		Tokenizer tokenizer = new LetterTokenizer(input);
		TokenFilter badLowerCaseFilter = new BadLowerCaseFilter(tokenizer);
		TokenFilter badStopFilter = new BadStopFilter(badLowerCaseFilter);
		TokenFilter stemFilter = new StemFilter(badStopFilter);
		return stemFilter;
	}
